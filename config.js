...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'Tristan;ᴊᴀʀᴠɪꜱ;https://graph.org/file/58ea74675af7836579a3a.jpg',
  WARN_COUNT: process.env.WARN_COUNT || '3',
  ANTILINK_MSG: process.env.ANTILINK_MSG || "_*yo! IDiot🫥Link Not allowed in this group*_",
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_6b71_9119_4a7d_e3c8_e879_c8be_e66f_e2ae',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '🎭;Tristan',
  ...
  GOODBYE_MSG: process.env.GOODBYE_MSG || "Hi $mention we won't miss you! ☺️",
  ...
  BOT_INFO: process.env.BOT_INFO || 'ᴊᴀʀᴠɪꜱ;Tristan;https://graph.org/file/1506e5842805b0968c5cf.mp4',
